...
export default function FloatingLaptop() {
    ...
    return (
        ...
        <Canvas dpr={[1, 2]} camera={{ position: [0, 0, -65], fov: 35 }} style={{ height: isSmallScreen ? "40vh" : "70vh" }} >
            <Suspense fallback={null}>
                <group rotation={[0, Math.PI, 0]} onClick={(e) => (e.stopPropagation(), setOpen(!open))}>
                    <Model open={open} hinge={props.open.to([0, 1], [1.575, -0.425])} scale={[2.5, 2.5, 2.5]} />
                </group>
                <Environment preset="city" />
            </Suspense>
            <ContactShadows position={[0, -4.5, 0]} opacity={0.4} scale={20} blur={1.75} far={4.5} />
            <OrbitControls enablePan={false} enableZoom={false} minPolarAngle={Math.PI / 2.2} maxPolarAngle={Math.PI / 2.2} enableRotate={true} />
        </Canvas>
