...
const projects = [
    { id: 1, name: "CRM", description: "A Customer Relationship Management and added custom features build for Peter and Pauls hospitality group" },
    { id: 2, name: "Locket", description: "An Admin console for Locket App." },
    { id: 3, name: "Portfolio", description: "Portfolio built using React JS, Three.js, Framer Motion, MUI" },
    { id: 4, name: "iSportz", description: "Admin panel for iSportz Inc. The Sports Tech Company" },
];
