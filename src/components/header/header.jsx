        ...
        <AppBar position="fixed" elevation={0}
            ...
            <Toolbar sx={{ justifyContent: 'space-between' }}>
                ...
                <motion.div
                    ...
                    initial={{ opacity: 0, y: -20 }}  // Optional: you can apply an initial state to the parent
                    animate={{ opacity: 1, y: 0 }}   // Optional: animate the parent
                    transition={{ duration: 0.7 }}     // Optional: control the transition timing
                >
